...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 130, False))
	$iIndex_Data = _ArraySearch($ItemArray, "Data", 0, 0, 0, 0, 1, 0, True) ;e' l'unico non preceduto da uno spazio
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 130, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 131, False))
	$iIndex_Nome = _ArraySearch($ItemArray, " Nome", 0, 0, 0, 0, 1, 0, True)
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 131, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 148, False))
	Local $i_almeno1, $s_work_tipo, $s_work_cod_oggetto
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 148, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 178, False))
	Global $s_work_Nome
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 178, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 182, False))
	Global $s_work_Campo_opzionale
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 182, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 192, False))
	Global $s_CALCOLATO_TOTALE_ACQ_EURO
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 192, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 215, False))
					Case $s_work_Valuta <> "EUR"
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 215, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("s_work_Valuta")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$s_work_Valuta", $s_work_Valuta))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 219, False))
			Case $s_works_tipo = "Pagamento express inviato"
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 219, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("s_works_tipo")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$s_works_tipo", $s_works_tipo))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 251, False))
								$sMsg = "Disallineamento record di input! Elaborazione abortita"
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 251, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("sMsg")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sMsg", $sMsg))

SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 252, False))
								$iRetValue = _ExtMsgBox($EMB_ICONSTOP, "OK", "Errore", $sMsg)
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 252, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("iRetValue")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$iRetValue", $iRetValue))
If SetError(@error, @extended, IsDeclared("EMB_ICONSTOP")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$EMB_ICONSTOP", $EMB_ICONSTOP))
If SetError(@error, @extended, IsDeclared("sMsg")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$sMsg", $sMsg))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 258, False))
					$s_work_URL_oggetto = $ItemArray[$i_row][$iIndex_Indirizzo_email]
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 285, False))
					If Not $i_cod_ritorno Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 285, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("i_cod_ritorno")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$i_cod_ritorno", $i_cod_ritorno))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 351, False))
								If Not $i_cod_ritorno Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 351, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("i_cod_ritorno")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$i_cod_ritorno", $i_cod_ritorno))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 417, False))
Func AccessConnectConn($s_dbname, ByRef $o_adoCon, $i_adoMDB = 1)
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 417, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("s_dbname")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$s_dbname", $s_dbname))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 486, False))
	If Not IsObj($o_adoCon) Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 486, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("o_adoCon")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$o_adoCon", $o_adoCon))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 632, False))
			Return SetError(1, 0, 0)
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 632, False, @error, @extended))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 634, False))
		$o_adoRs.AddNew
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 634, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("o_adoRs")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$o_adoRs", $o_adoRs))
...
SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 639, False))
		If $i_sw_PBL Then
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 639, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("i_sw_PBL")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$i_sw_PBL", $i_sw_PBL))

SetError(@error, @extended, AutoIt_Debugger_NextLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 640, False))
			$o_adoRs.Fields("NOTE") = "S.& H."
SetError(@error, @extended, AutoIt_Debugger_FinishedLine("H:\ISN AutoIt Studio\Projects\Elabora Acquisti Ebay via Paypal GUI\Elabora Acquisti Ebay via Paypal GUI.au3", "Elabora Acquisti Ebay via Paypal GUI.au3", 640, False, @error, @extended))
If SetError(@error, @extended, IsDeclared("o_adoRs")) Then SetError(@error, @extended, AutoIt_Debugger_SendVariable("$o_adoRs", $o_adoRs))
