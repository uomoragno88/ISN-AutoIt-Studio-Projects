...
Func Prosegui_click()
	Select
		Case $s_provenienza = "EBAY"
			...
			Tratta_Ebay($p5, $hArea_Comunicazioni)
...
Func Tratta_Ebay($p5, $hArea_Comunicazioni)
	Local $o_Con, $o_Rs
	;DATA========================================================
	Select
		Case $s_ambiente = "TEST"
...
;~ 			MsgBox($MB_OK, "Prepara busta", "Oggetto: " & $s_Descrizione_Oggetto & @CRLF & _
